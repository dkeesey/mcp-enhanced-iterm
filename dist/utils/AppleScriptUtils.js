...
export class AppleScriptUtils {
     ...
     */
    static async executeSimpleScript(script) {
        try {
     ...
     */
    static async executeMultiLineScript(lines) {
        try {
            const args = lines
     ...
     */
    static async executeScriptWithVariables(scriptTemplate, variables) {
     ...
     */
    static async getSessionVariable(sessionId, variableName) {
        const script = `
tell application "iTerm2"
  ...
  return "not found"
     ...
     */
    static async setSessionVariable(sessionId, variableName, value) {
        const script = `
tell application "iTerm2"
  repeat with aWindow in windows
    repeat with aTab in tabs of aWindow
...
//# sourceMappingURL=AppleScriptUtils.js.map